...
Anomaly::Anomaly(uint8_t proto, std::shared_ptr<IpRule> & rl):rule_(rl),
        monitor_(proto),proto_(proto){}
Anomaly::Anomaly(const Anomaly & oth):rule_(oth.rule_),monitor_(oth.monitor_),proto_(oth.proto_){}
